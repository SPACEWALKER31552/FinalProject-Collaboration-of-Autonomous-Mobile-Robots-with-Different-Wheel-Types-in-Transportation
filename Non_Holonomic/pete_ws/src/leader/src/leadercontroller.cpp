...
int main(int argc, char** argv){
  ...
  ros::Subscriber sub = n.subscribe("leaderspeed", 50, handle_speed);
 ros::Subscriber subimu = n.subscribe("leaderIMU",1000,handle_imu); 
 ros::Publisher odom_pub = n.advertise<nav_msgs::Odometry>("leaderodom", 50);
  ros::Publisher myodom_pub = n.advertise<geometry_msgs::Pose>("leaderfortheta", 50);
  ...
  double vy = 0.0;
  double vth = 0.0;
  char base_link[] = "/base_linkleader";
  char odom[] = "/odom";
  char kinect[] = "/kinect";
