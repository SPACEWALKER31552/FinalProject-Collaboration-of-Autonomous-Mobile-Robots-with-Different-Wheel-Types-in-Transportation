...
void position_control(int tg1_input, int tg2_input, int tg3_input){
  ...
  ATOMIC_BLOCK(ATOMIC_RESTORESTATE) {
    pos1 = getPositionSPI(ENC_1, RES14);
  }
  ...
  // signal the motor
  if(getPositionSPI(ENC_1, RES14)<=5248 || getPositionSPI(ENC_1, RES14)>=9500)
    {pwr1 = 0;}
  ...
  int pos2 = 0; 
  ATOMIC_BLOCK(ATOMIC_RESTORESTATE) {
    pos2 = getPositionSPI(ENC_3, RES14);
  }
  ...
  // signal the motor
  if(getPositionSPI(ENC_3, RES14)<=10340 || getPositionSPI(ENC_3, RES14)>=14000)
    {pwr2 = 0;}
  ...
  int pos3 = 0; 
  ATOMIC_BLOCK(ATOMIC_RESTORESTATE) {
    pos3 = getPositionSPI(ENC_5, RES14);
  }
  ...
  // signal the motor
  if(getPositionSPI(ENC_5, RES14)<=5150 || getPositionSPI(ENC_5, RES14)>=9000)
    {pwr3 = 0;}
...
uint16_t encoderPositionIN1;
uint16_t encoderPositionIN2;
uint16_t encoderPositionIN3;
uint16_t encoderPositionIN4;
uint16_t encoderPositionIN5;
uint16_t encoderPositionIN6;
...
void loop() {
  ...
  if(os1 == 0 || os2 == 0 || os3 == 0 ){
      ...
      encoderPosition5 = getPositionSPI(ENC_5, RES14); 
      encoderPosition6 = getPositionSPI(ENC_6, RES14);
      if(getPositionSPI(ENC_1, RES14)>=encoderPositionIN1){
      deg1 = (getPositionSPI(ENC_1, RES14)-encoderPositionIN1)*0.0219726563;
    }
    else if(getPositionSPI(ENC_1, RES14)<encoderPositionIN1){
    deg1 = 0;
    }

    if(getPositionSPI(ENC_2, RES14)>=encoderPositionIN2){
      deg2 = (getPositionSPI(ENC_2, RES14)-encoderPositionIN2)*0.0219726563;
    }
    else if(getPositionSPI(ENC_2, RES14)<encoderPositionIN2){
    deg2 = 0;
    }

    if(getPositionSPI(ENC_3, RES14)>=encoderPositionIN3){
      deg3 = (getPositionSPI(ENC_3, RES14)-encoderPositionIN3)*0.0219726563;
    }
    else if(getPositionSPI(ENC_3, RES14)<encoderPositionIN3){
    deg3 = 0;
    }

    if(getPositionSPI(ENC_4, RES14)>=encoderPositionIN4){
      deg4 = (getPositionSPI(ENC_4, RES14)-encoderPositionIN4)*0.0219726563;
    }
    else if(getPositionSPI(ENC_4, RES14)<encoderPositionIN4){
    deg4 = 0;
    }

    if(getPositionSPI(ENC_5, RES14)>=encoderPositionIN5){
      deg5 = (getPositionSPI(ENC_5, RES14)-encoderPositionIN5)*0.0219726563;
    }
    else if(getPositionSPI(ENC_5, RES14)<encoderPositionIN5){
    deg5 = 0;
    }

    if(getPositionSPI(ENC_6, RES14)>=encoderPositionIN6){
      deg6 = (getPositionSPI(ENC_6, RES14)-encoderPositionIN6)*0.0219726563;
    }
    else if(getPositionSPI(ENC_6, RES14)<encoderPositionIN6){
    deg6 = 0;
    }
    ...
    if((millis() - startMillis) < 5000){ 
      ...
      //Serial.print("Vx: ");
      //Serial.print(vx); //print the position X
      //Serial.print("\t");
      //Serial.print("Vy: ");
      //Serial.print(vy);
      //Serial.write(NEWLINE);
