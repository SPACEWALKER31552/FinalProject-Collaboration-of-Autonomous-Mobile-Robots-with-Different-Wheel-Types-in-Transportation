...
void setup() 
 ...
 void loop() {
  ...
  /*
    if(abs(slavezeta - goalangleslave) >= abs(leaderzeta - goalangleleader)-10)
    {  
    // errorleader
    int eleader = (slavezeta - goalangleslave)-(leaderzeta - goalangleleader);
    // control signal
    float uleader = eleader;*/
    int signI = 0 ;
    if (angz > 0)
    {
      signI = 1 ;
    ...
    //IMUprogram.vector.x = slavezeta - goalangleslave ;//goalangleleader;
    //IMUprogram.vector.y = leaderzeta - goalangleleader;//goalangleslave; 
