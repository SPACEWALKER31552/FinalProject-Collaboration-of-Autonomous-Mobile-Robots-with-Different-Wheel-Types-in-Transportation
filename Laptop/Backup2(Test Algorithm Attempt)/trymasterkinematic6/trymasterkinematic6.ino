   ...
   if((millis()-lastmillis) >= Looptime)
    {
     ...
     if((slave2zeta - startz+19.45)>0)
     {
      slave2diff = slave2zeta - startz + 19.45;
     ...
     else if((slave2zeta - startz+19.45)<0)
     {
     slave2diff = slave2zeta - startz + 19.45;
     //Serial.println(slave2diff);
     if(slave2diff<-360)
    ...
    // slave --------------------------------------------------------------------------------------
    if((slavezeta - startz-19.45)>0)
     {
      slavediff = slavezeta - startz - 19.45;
     ...
     else if((slavezeta - startz-19.45)<0)
     {
     slavediff = slavezeta - startz - 19.45;
     //Serial.println(slavediff);
     if(slavediff<-360)
    ...
    follower3velocity.angular.z = angz;
