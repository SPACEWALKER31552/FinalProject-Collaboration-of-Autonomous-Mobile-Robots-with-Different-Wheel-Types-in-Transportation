...
*/
  ...
  follower1velocity.linear.x = 1.7*linx ;
  follower1velocity.angular.z = (1*angz);//+uleader; ;
  follower1velocity_msg.publish(&follower1velocity);
  
  follower2velocity.linear.x = linx ;
  follower2velocity.angular.z = curveslave ;//uslave ;
  follower2velocity_msg.publish(&follower2velocity);
  
  follower3velocity.linear.x = linx ;
  follower3velocity.angular.z = curveslave ; //uslave2 ;
