...
{       
  ...
  goalangleslave= holoodompy.angular.y ;
...
void loop() {
  ...
  {                                                                           // enter timed loop
    ...
    if(goalangleslave != goalangleslaveold)
    {
    float kpp = 0.03;

    // errorleader
    int eslave = goalangleslave - mpu.getAngleZ();

    // control signal
    float uslave = kpp * eslave ;

    // store previous error
    eprevslave = eslave;
    goalangleslaveold = goalangleslave;
    angz = angz + uslave ;
    }
    ...
    PWM_Motor1 = constrain(speed_req_motor1*(255/0.26), -255, 255); 
    PWM_Motor2 = constrain(speed_req_motor2*(255/0.26), -255, 255);
    PWM_Motor3 = constrain(speed_req_motor3*(255/0.26), -255, 255);
    PWM_Motor4 = constrain(speed_req_motor4*(255/0.26), -255, 255);
