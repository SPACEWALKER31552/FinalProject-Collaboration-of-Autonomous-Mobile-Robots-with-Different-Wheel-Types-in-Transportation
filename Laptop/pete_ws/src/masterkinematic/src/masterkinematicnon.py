...
def main():
    ...
    cmdslave = rospy.Publisher('non1/cmd_vel', Twist, queue_size = 10)  
    cmdslave2 = rospy.Publisher('non2/cmd_vel', Twist, queue_size = 10)
    cmdslave3 = rospy.Publisher('non3/cmd_vel', Twist, queue_size = 10)
