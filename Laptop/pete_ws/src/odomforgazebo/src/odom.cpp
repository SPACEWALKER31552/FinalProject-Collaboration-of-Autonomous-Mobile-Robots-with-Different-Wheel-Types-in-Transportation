...
{
	linx = handle_speed.twist.linear.x ;
	liny = handle_speed.twist.linear.y ;
	angz = handle_speed.twist.angular.z ;
        speed_act1 = (1/7.25)*(linx-liny-((1.8+1.75)*angz)) ;
	speed_act2 = (1/7.25)*(linx-liny-((1.8+1.75)*angz)) ;
	speed_act3 = (1/7.25)*(linx-liny-((1.8+1.75)*angz)) ;
	speed_act4 = (1/7.25)*(linx-liny-((1.8+1.75)*angz)) ;
...
int main(int argc, char **argv)
{
	...
	ros::Subscriber subspeed = n.subscribe("cmd_velforgazebo", 1000, handle_speed);

	ros::Publisher odom_pub = n.advertise<nav_msgs::Odometry>("mineodom", 50);
